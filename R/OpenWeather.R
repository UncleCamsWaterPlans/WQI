...
#Requires:
#City == the City as displayed in the cityList file extracted from the website
#APIKEY == given from the free tier account for OpenWeather
#time == UNIX time for a given day. Free tier only supports the last 5 days

#returns time as "Australia/Brisbane" (UTC+10)
